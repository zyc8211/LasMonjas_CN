    ...
    public static class Helpers {
        ...
        public static Sprite loadSpriteFromResources(string path, float pixelsPerUnit) {
            try {
                ...
                System.Console.WriteLine("��·������ͼ��ʱ����: " + path);
            }
            return null;
        }
        ...
        public static unsafe Texture2D loadTextureFromResources(string path) {
            try {
                ...
                System.Console.WriteLine("����Դ�м�������ʱ����: " + path);
            }
            return null;
        }
        ...
        public static Texture2D loadTextureFromDisk(string path) {
            try {          
                ...
                System.Console.WriteLine("��Ӳ���м�������ʱ����: " + path);
            }
            return null;
        }
        ...
        public static void refreshRoleDescription(PlayerControl player) {
            ...
            foreach (RoleInfo roleInfo in infos) {
                ...
                if (roleInfo.name == "Renegade") {
                    var getMinionText = Renegade.canRecruitMinion ? " ��ļһ��צ��" : "";
                    task.Text = cs(roleInfo.color, $"{roleInfo.name}: ɱ��������{getMinionText}");  
                } else {
